  ...
  return (
    <div className="container mt-5">
      <div className="d-flex justify-content-between align-items-center mb-4">
        <h3><i className="fas fa-users me-2"></i>Candidates</h3>
            ...
            <div className="modal-content">
              <form onSubmit={handleSaveCandidate}>
                <div className="modal-header">
                  <h5 className="modal-title">{editingId ? 'Edit Candidate' : 'Add Candidate'}</h5>
                ...
                <div className="modal-body">
                  ...
                  <input className="form-control mb-2" name="code" value={formData.code} onChange={handleChange} placeholder="Code" required />
                  ...
                  <input className="form-control mb-2" name="position" value={formData.position} onChange={handleChange} placeholder="Position" />
                </div>
